  ...
  return (
    <SectionWrapper id="work">
      ...
      {projects.map((project, i) => (
        ...
        >
          <Heading level="sub" className="group-hover:text-indigo transition-colors duration-300">
            {project.name}
          </Heading>

          <div className="flex items-center gap-8">
            <Text level="caption" as="span" className="hidden sm:block">
              {project.tag}
            </Text>
            <Text level="caption" as="span">
              {project.year}
            </Text>
